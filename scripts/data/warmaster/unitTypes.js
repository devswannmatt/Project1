...
const unitTypesData = [
    ...
    { name: 'Artillery (Mobile)',   description: 'A mobile Long-range unit with powerful but slow attacks, often requiring support.', movement: 20 },
    { name: 'Machine',              description: 'Long-range units with powerful but slow attacks, often requiring support.', movement: 10 },
    { name: 'Machine (Mobile)',     description: 'A mobile Long-range unit with powerful but slow attacks, often requiring support.', movement: 20 },
    { name: 'Machine (Pushed)',     description: 'This machine requires an Infantry unit to push it. See Special Rules.', movement: 20 },
